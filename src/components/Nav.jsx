...
const Nav=()=>{
    return <nav className="w-full text-white text-sm lg:text-[0.9rem] flex justify-between items-center bg-[#9e9e9e1b] backdrop-blur-[5px]">
        ...
        <div className="right py-1 px-3 gap-1 w-45 flex justify-around items-center">
